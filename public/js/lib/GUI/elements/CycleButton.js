...
(function() {
  define([], function() {
    ...
    return root.CycleButton = (function() {
      function CycleButton(opt) {
        ...
        if (opt.items) {
          ...
          _fn = function() {
            if (opt.colors) {
              return _this.mother.append("<p " + (opt.current === i ? 'class=current' : '') + " style=\"background: " + opt.colors[i] + "\">" + item + "</p>");
            } else {
      ...
      CycleButton.prototype.get_val = function() {
        if (this.values) {
      ...
      CycleButton.prototype.set_val = function(val) {
        this.current.hide();
        this.current.removeClass('current');
        this.current_index = this.values.indexOf(val);
        this.current = $(this.items[this.current_index]);
        this.current.addClass('current');
        return this.current.show();
      };

      CycleButton.prototype.get_text = function() {
