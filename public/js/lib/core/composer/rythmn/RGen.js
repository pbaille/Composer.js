...
(function() {
  define(["lib/core/base/RVal", "lib/core/base/Note", "lib/utils/Rational", "lib/utils/index", "lib/midi/play", "vendors/underscore"], function() {
    ...
    return root.RGen = (function() {
      ...
      RGen.prototype.build_prob_array = function(opt) {
        var base, bounds, median, median_weight, poly_prob;
        base = opt.base || 2;
        poly_prob = opt.prob || {
          bin: 1,
          ter: 0,
        ...
        median = opt.median || new RVal(1, 2);
        bounds = opt.bounds || [new RVal(2), new RVal(1, 4)];
        return median_weight = opt.median_weight || 0.5;
      };
