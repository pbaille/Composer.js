  ...
  define([], function() {
    ...
    Metronome = (function() {
      ...
      Metronome.prototype.start = function() {
        var instance, l, speed, _i, _len, _ref,
          _this = this;
        ...
        this.bars = 0;
        this.count = 0;
        speed = 60000 / (this.bpm * this.unit);
        ...
        return setTimeout(instance, speed);
      };
      ...
      Metronome.prototype.total = function() {
        return rat(this.count, this.beats * this.unit).plus(this.bars);
      };

      Metronome.prototype.check_precision = function() {
        return (window.performance.now() - this.origin_point) - this.total().toFloat() * 1000;
      };
